 ...
 */
#define USE_CONTROLLER_FAN // BTT_E3_V3 marlin example
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN FAN2_PIN       // Set a custom pin for the controller fan // BTT_E3_V3 marlin example
  ...
  #define CONTROLLER_FAN_EDITABLE         // Enable M710 configurable settings // BTT_E3_V3 marlin example
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // BTT_E3_V3 marlin example
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 200 // BTT_E3_V3 consol guide
   ...
   */
  #define BLTOUCH_SET_5V_MODE // BTT_E3_V3 consol guide
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' // BTT_E3_V3 consol guide
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // Scroll long filenames in the SD card menu // BTT_E3_V3 consol guide
   ...
   */
  #define SDCARD_CONNECTION ONBOARD // BTT_E3_V3 consol guide
 ...
 */
#define BABYSTEPPING // BTT_E3_V3 consol guide
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  #define BABYSTEP_WITHOUT_HOMING // BTT_E3_V3 consol guide
  #define BABYSTEP_ALWAYS_AVAILABLE         // Allow babystepping at all times (not just during movement). // BTT_E3_V3 consol guide
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  #define BABYSTEP_MILLIMETER_UNITS         // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps // BTT_E3_V3 consol guide
  #define BABYSTEP_MULTIPLICATOR_Z  0.01    // (steps or mm) Steps or millimeter distance for each Z babystep // BTT_E3_V3 consol guide
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping. // BTT_E3_V3 consol guide
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping // BTT_E3_V3 consol guide
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY   // Enable graphical overlay on Z-offset editor // BTT_E3_V3 consol guide
  #endif
#endif
 ...
 */
#define G29_RETRY_AND_RECOVER // BTT_E3_V3 consol guide
...
// G2/G3 Arc Support
//
// #define ARC_SUPPORT                   // Requires ~3226 bytes // BTT_E3_V3 consol guide
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE  32 // BTT_E3_V3 consol guide
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 64 // BTT_E3_V3 consol guide
#else
  #define BLOCK_BUFFER_SIZE 64 // BTT_E3_V3 consol guide
#endif
...
#define TX_BUFFER_SIZE 128 // BTT_E3_V3 consol guide
 ...
 */
#define ADVANCED_PAUSE_FEATURE // BTT_E3_V3 consol guide
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      450  // (mm) The length of filament for a complete unload. // BTT_E3_V3 consol guide
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   6  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     20  // (mm) Slow length, to allow time to insert material. // BTT_E3_V3 consol guide
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   6  // (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     410  // (mm) Load length of filament, from extruder gear to nozzle. // BTT_E3_V3 consol guide
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_FANS_PAUSE             // Turn off print-cooling fans while the machine is paused. // BTT_E3_V3 consol guide
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. // BTT_E3_V3 consol guide
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. // BTT_E3_V3 consol guide
  #define FILAMENT_UNLOAD_ALL_EXTRUDERS         // Allow M702 to unload all extruders above a minimum target temp (as set by M302) // BTT_E3_V3 consol guide
#endif
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current. // BTT_E3_V3 marlin example
    ...
    #define Y_CURRENT       580 // BTT_E3_V3 marlin example
    ...
    #define Z_CURRENT       580 // BTT_E3_V3 marlin example
    ...
    #define E0_CURRENT      650 // BTT_E3_V3 consol guide
   ...
   */
    ...
    // #define STEALTHCHOP_E // BTT_E3_V3 consol guide
  #endif
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below) // BTT_E3_V3 consol guide
   ...
   */
  #define MONITOR_DRIVER_STATUS // BTT_E3_V3 consol guide
   ...
   */
  #define HYBRID_THRESHOLD // BTT_E3_V3 consol guide

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      15 // BTT_E3_V3 consol guide
   ...
   */
  #define TMC_DEBUG // BTT_E3_V3 consol guide
 ...
 */
#define HOST_ACTION_COMMANDS // BTT_E3_V3 Octoprint Firmwarecheck plugin
...
//
#define PINS_DEBUGGING // BTT_E3_V3 consol guide
